...
const CustomerProfileEdit: any = ({navigation}: {navigation: any}) => {
  ...
  const updateCustomer = () => {
    ...
    if(!gstInReg.test(gstin)){
      ...
      return
          ...
          UpdateCustomerProfile(Id, token, body)
            .then(res => {
              setLoading(false);
              if (res.status === 200) {
                navigation.goBack();
  ...
  return (
    <View style={styles.container}>
      ...
      <PostAuthWrapper
        titlePreFix={I18n.t('customerProfileEdit.customer_edit_name_prefix')}
        titlePostFix={I18n.t('customerProfileEdit.customer_edit_name_postfix')}
        subtitle={''}
        navigation={navigation}
        ...
        <>
          <Input
            ...
            label={I18n.t('customerProfileEdit.customer_input_name')}
            value={name}
            onChange={text => {
              setName(text);
              if(text.length>1){
          ...
          <Input
            secureTextEntry={false}
            label={I18n.t('customerProfileEdit.customer_input_phone')}
            value={mobileNumber}
            onChange={text => {
...
{phoneErr && (
          ...
          <Input
            secureTextEntry={false}
            label={I18n.t('customerProfileEdit.customer_input_email')}
            value={email}
            onChange={text => {
              setEmail(text);
              if(text.length>1){
...
{emailErr && (
          ...
          <Input
            secureTextEntry={false}
            label={I18n.t('customerProfileEdit.customer_input_landline')}
          ...
          <Input
            secureTextEntry={false}
            label={I18n.t('customerProfileEdit.customer_input_address')}
            value={address1}
            onChange={text => {
              setAddress1(text);
            }}
...
{address2Err && (
          ...
          <Input
            secureTextEntry={false}
            label={I18n.t('customerProfileEdit.customer_dropdown_district')}
            value={city}
            onFocus={() => {}}
            onChange={text => {
              setCity(text);
          ...
          <Input
            secureTextEntry={false}
            label={I18n.t('customerProfileEdit.customer_dropdown_state')}
            value={state}
            onFocus={() => {}}
            onChange={text => {
              setState(text);
          ...
          <Input
            secureTextEntry={false}
            label={I18n.t('customerProfileEdit.customer_input_latitude')}
            value={latLng}
            onFocus={() => {}}
            onChange={text => {
              setLatLng(text);
          ...
          <Input
            secureTextEntry={false}
            label={I18n.t('customerProfileEdit.customer_input_pan')}
            value={pan}
            onChange={text => {
              setPan(text);
            }}
...
{gstInErr && (
          ...
          <View style={styles.sliderContainer}>
            <Text style={styles.sliderText}>
              {I18n.t('customerProfileEdit.customer_logo')}
            </Text>
          ...
          <View style={styles.sliderContainer}>
            <Text style={styles.sliderText}>
              {I18n.t('customerProfileEdit.customer_certificate')}
            </Text>
            <View style={styles.sliderContent}>
          ...
          <View style={{marginBottom: 20}}>
            <Button
              ...
              {I18n.t('customerProfileEdit.customer_button_proceed')}
            </Button>
          </View>
        </>
      </PostAuthWrapper>
