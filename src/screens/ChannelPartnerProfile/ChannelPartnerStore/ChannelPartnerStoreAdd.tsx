...
import styles from './ChannelPartnerStore.styles'
import { createNewChannelPartnerStore, getChannelPartnerStoreById, updateChannelPartnerStore } from '../../../api/channelPartnerApi';
...
const ChannelPartnerAddStore: any = ({ navigation, route }: { navigation: any, route: any }) => {
  ...
  useEffect(() => {
    ...
    if (route.params.type === 'edit') {
      ...
      AsyncStorage.multiGet(['API_TOKEN', 'USER_ID'], (err, items) => {
        ...
        settoken(items[0][1]);
        getChannelPartnerStoreById(route.params.storeId, items[0][1])
          .then(res => {
        ...
        if (valid) {
          ...
          AsyncStorage.multiGet(['API_TOKEN', 'USER_ID'], (err, items) => {
            ...
            if (route.params.type === 'edit') {
              ...
              updateChannelPartnerStore(route.params.storeId, token, body)
                .then(res => {
                  if (res.status === 200) {
                    navigation.goBack();
                    setloader(false);
                ...
                createNewChannelPartnerStore(items[0][1], body)
                .then(res => {
                  setloader(false);
                  navigation.goBack();
                })
...
export default ChannelPartnerAddStore
