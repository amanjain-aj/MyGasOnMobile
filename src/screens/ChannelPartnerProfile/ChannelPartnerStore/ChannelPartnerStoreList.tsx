...
const ChannelPartnerStoreList = ({
  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      AsyncStorage.multiGet(['API_TOKEN', 'USER_ID'], (err, items) => {
        ...
        settoken(items[0][1]);
        getStoreByChannelPartner(items[1][1], items[0][1], 1)
          .then(res => {
            console.log(res);
  ...
  const deleteStoreItem = () => {
    setToDelete(false);
    deleteChannelPartnerStore(storeID, token)
      .then(res => {
        if (res.status === 200) {
          console.log(res);
            ...
            <View style={{display: 'flex', flexDirection: 'row'}}>
              ...
              <View style={styles.icon2Container}>
                <Icon
                  ...
                  size={17}
                  onPress={() => {
                    navigation.navigate('ChannelPartnerStoreAdd', {
  ...
  return (
    <View style={styles.contanier}>
      ...
      <Header navigation={navigation} title={I18n.t('channelPartnerHome.header')} />
      <PostAuthWrapper
      ...
      <FooterTab
        navigation={navigation}
        onAddRoute={'ChannelPartnerStoreAdd'}
        isAdd={true}
        navigationData={{
          firstname: route.params.firstname,
          lastname: route.params.lastname,
...
export default ChannelPartnerStoreList;
