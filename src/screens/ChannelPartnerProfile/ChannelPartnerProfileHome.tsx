...
import styles from './ChannelPartnerProfile.styles';
...
import {getChannelPartnerProfile} from '../../api/channelPartnerApi';

const ChannelPartnerProfileHome: any = ({navigation}: {navigation: any}) => {
    ...
    React.useCallback(() => {
      ...
      AsyncStorage.multiGet(
        ...
        (err, items) => {
          ...
          setRole(items[2][1]);
          getChannelPartnerProfile(items[1][1], items[0][1])
            .then(res => {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <PostAuthWrapper
        EditRoute={'ChannelPartnerProfileEdit'}
        titlePreFix={
        ...
        <View style={styles.cardBox}>
          <Card
            ...
            onPress={() => {
              navigation.navigate('ChannelPartnerStaffList', {
            ...
            <Card.Content>
              <Title style={styles.cardTitle}>
                {I18n.t('channelPartnerHome.menu_staff')}
              </Title>
            </Card.Content>
            <Card.Actions style={styles.action}>
              ...
              <IconButton icon="arrow-right" color={config.FADED_BLUE} size={18} />
            </Card.Actions>
          </Card>
          ...
          <Card
            style={styles.cardContent}
            onPress={() => {
              navigation.navigate('ChannelPartnerStoreList', {
                firstname: getSplitNames(0, profileData.basicInfo.name),
                lastname: getSplitNames(1, profileData.basicInfo.name),
              });
            }}>
            <Card.Content>
              <Title style={styles.cardTitle}>
                {I18n.t('channelPartnerHome.menu_stores')}
              </Title>
            </Card.Content>
            <Card.Actions style={styles.action}>
              <View style={styles.iconBox}>
        ...
        <View style={styles.cardBox}>
          <Card
            style={styles.cardContent}
            onPress={() => {
              navigation.navigate('ChannelPartnerAgency',{
                firstname: getSplitNames(0, profileData.basicInfo.name),
                lastname: getSplitNames(1, profileData.basicInfo.name),
              });
            }}>
            <Card.Content>
              <Title style={styles.cardTitle}>
                {I18n.t('channelPartnerHome.menu_agency')}
              </Title>
            </Card.Content>
            <Card.Actions style={styles.action}>
              <View style={styles.iconBox}>
...
export default ChannelPartnerProfileHome;
