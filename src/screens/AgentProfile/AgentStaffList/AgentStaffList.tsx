...
const AgentStaffList = ({navigation, route}: {navigation: any; route: any}) => {
  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      AsyncStorage.multiGet(['API_TOKEN', 'USER_ID'], (err, items) => {
        ...
        settoken(items[0][1]);
        getAgentStaffList(items[0][1], 0, items[1][1])
          .then(res => {
